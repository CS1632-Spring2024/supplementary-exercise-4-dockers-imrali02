...
public class D3Test {
  ...
  public void tEST1LINKS() {
    ...
    js.executeScript("document.cookie = \"1=false\";document.cookie = \"2=false\";document.cookie = \"3=false\";");
    {
      ...
      vars.put("linkVal", attribute);
    }
    assertEquals(vars.get("linkVal").toString(), "https://cs1632.appspot.com/reset");
    driver.close();
  }
  ...
  public void tEST3CATALOG() {
    ...
    driver.findElement(By.linkText("Catalog")).click();
    {
      ...
      vars.put("imgVal", attribute);
    }
    assertEquals(vars.get("imgVal").toString(), "https://cs1632.appspot.com/images/cat2.jpg");
    driver.close();
  }
